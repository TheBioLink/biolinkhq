  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/10 hover:border-white/25"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-[100]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="w-full max-w-[510px] overflow-hidden rounded-[26px] border border-[#1d2b63] bg-[#071233] shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <button
                      type="button"
                      onClick={copyLink}
                      className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/12 bg-[#08163d] px-4 py-4 text-sm font-semibold text-white transition hover:bg-[#0a1b4a] hover:border-white/20"
                    >
                      <FontAwesomeIcon
