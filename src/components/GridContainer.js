...
const items = [
  ...
  },
  {
    ...
    // updated branding from Linktree to Biolinkhq
    description: 'Create your own Biolinkhq in just seconds and customize it in a way that reflects your brand or style.'
  },
  {
    Icon: FaQrcode,
  ...
  {
    Icon: FaPlug,
    title: 'Integrate your Biolinkhq with your existing tech',
    description: 'Biolinkhq seamlessly connects to other platforms like Mailchimp, Vimeo, Zapier, Amazon, YouTube, Google Analytics, plus more!'
  },
];
