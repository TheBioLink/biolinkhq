  ...
  return (
    <main>
      ...
      <div className="mt-20 text-center max-w-5xl">
        ...
        <p>
          Back in 2016 the original link‑in‑bio platforms solved social media’s most annoying problem: only
          having one link in your bio. Biolinkhq continues that tradition and has since become so much
